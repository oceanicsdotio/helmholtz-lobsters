...
The ability to change the apparent orientation of the geomagnetic field has applications in study of competent dispersal and population connectivity which could be altered by the fields induced by midwater and submarine direct-current cables. Future *in situ* work should investigate whether *H. americanus* post-larvae utilize a polarity compass in settlement and determine how individual behavior could scale to population distribution. Three such arrays can be aligned to x- y- and z-axes and controlled sensors and a microcontroller to maintain a static uniform field in a moored or drifting apparatus (Diament 2000).
